...
const PROJECTS = [
  ...
  },
  {
    ...
    desc: "Solução industrial completa desenvolvida com React, Tailwind CSS e Firebase para gestão de resíduos, controle de estoque, emissão de NF-e e relatórios financeiros automatizados.",
